        ...
        for (int i = (int)sprints.count-1; i >= 0; i--) {
            ...
            if ([sprints[i] valueForKey:@"id_sprint"] != nil) {
                ...
                if (arrayTodo.count == 0) {
                    Task* emptyTask = [[Task alloc] initWithId:@"" title:@"Pas de tâche" description:@"" difficulty:@"" priority:@"" id_category:0 businessValue:@"" duration:@"" status:@"" id_creator:@"" taskDone:nil id_members:nil];
