...
- (instancetype) initWithId:(NSString*)id_sprint beginningDate:(NSString*)beginningDate endDate:(NSString*)endDate id_creator:(NSString*)id_creator id_listTasks:(NSMutableArray*)id_listTasks id_members:(NSMutableArray*)id_members;
